...
wallet = input("8a33e2dc4a137f5b5e8f269373bd615251dd70f64bc8a424465e80d3ab975341")
email = input("djr6012@gmail.com")
user_id = input("420830")
video = input("https://fanzy.page.link/KC41ehFF5RRhKCj18")
def run():
    num = 1
